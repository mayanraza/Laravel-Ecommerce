        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>${{ number_format($currentMonthTotalRevenue, 2) }}</h3>
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>${{ number_format($previousMonthTotalRevenue, 2) }}</h3>
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>${{ number_format($Last30DayTotalRevenue, 2) }}</h3>
                            <p>Total Last 30 Day Revenue</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person-add"></i>
                        </div>
