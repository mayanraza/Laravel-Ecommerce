                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control"
                                        placeholder="Coupon Code" value="{{$discount->code}}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Coupon code name" value="{{$discount->name}}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_uses" id="max_uses" class="form-control"
                                        placeholder="Max Uses" value="{{$discount->max_uses}}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_uses_user" id="max_uses_user" class="form-control"
                                        placeholder="Max Uses User" value="{{$discount->max_uses_user}}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="discount_amount" id="discount_amount" class="form-control"
                                        placeholder="Discount Amount" value="{{$discount->discount_amount}}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_amount" id="min_amount" class="form-control"
                                        placeholder="Min Amount" value="{{$discount->min_amount}}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="starts_at" id="starts_at"
                                        class="form-control" placeholder="Starts At" value="{{$discount->starts_at}}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="expires_at" id="expires_at"
                                        class="form-control" placeholder="Expires At" value="{{$discount->expires_at}}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea type="text" rows="5" class="form-control" name="description" id="description"
                                    class="form-control" placeholder="Description">{{$discount->description}}</textarea>
                                <p></p>
                            </div>
